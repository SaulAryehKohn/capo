...
OMNIPATH_s1e1='/data4/paper/2013EoR/Analysis/ProcessedData/epoch1/omni_v5_xtalk_4pol/'
OMNIPATH_s1e2='/data4/paper/2013EoR/Analysis/ProcessedData/epoch2/omni_v5_xtalk_4pol/'
...
FCAL_s1e1_xx='/data4/paper/2013EoR/Analysis/ProcessedData/epoch1/omni_v5_xtalk/zen.2456620.17387.xx.uvcRREc.median.fc.npz'
FCAL_s1e2_xx='/data4/paper/2013EoR/Analysis/ProcessedData/epoch2/omni_v5_xtalk/zen.2456680.18774.xx.uvcRREc.median.fc.npz'
...
FCAL_s1e1_yy='/data4/paper/2013EoR/Analysis/ProcessedData/epoch1/omni_v5_xtalk/zen.2456620.17387.yy.uvcRREc.median.fc.npz'
FCAL_s1e2_yy='/data4/paper/2013EoR/Analysis/ProcessedData/epoch2/omni_v5_xtalk/zen.2456680.17382.yy.uvcRREc.median.fc.npz'
...
for f in ${ARGS}; do
    ...
    if ((${fQ:4:7} > 2456677 && ${fQ:4:7} < 2456836)); then
...
for f in ${ARGS}; do
    ...
    if ((${fQ:4:7} < 2456679 )); then
        ...
        echo ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s1e1} --ex_bls=${BADBLS} --ba=${BADANTS_s1e1} ${fFc}
        ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s1e1} --ex_bls=${BADBLS} --ba=${BADANTS_s1e1} ${fFc}
    ...
    if ((${fQ:4:7} > 2456678 && ${fQ:4:7} < 2456836)); then
        ...
        echo ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s1e2} --ex_bls=${BADBLS} --ba=${BADANTS_s1e2} ${fFc}
        ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s1e2} --ex_bls=${BADBLS} --ba=${BADANTS_s1e2} ${fFc}
    ...
    if (( ${fQ:4:7} > 2456836 && ${fQ:4:7} < 2456875 )); then
        ...
        echo ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s2e2} --ex_bls=${BADBLS} --ba=${BADANTS_s2e2} ${fFc}
        ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s2e2} --ex_bls=${BADBLS} --ba=${BADANTS_s2e2} ${fFc}
    ...
    if (( ${fQ:4:7} > 2456881 && ${fQ:4:7} < 2456929 )); then
        ...
        echo ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s2e3} --ex_bls=${BADBLS} --ba=${BADANTS_s2e3} ${fFc}
        ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s2e3} --ex_bls=${BADBLS} --ba=${BADANTS_s2e3} ${fFc}
    ...
    if (( ${fQ:4:7} > 2456941 )); then
        ...
        echo ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s2e4} --ex_bls=${BADBLS} --ba=${BADANTS_s2e4} ${fFc}
        ${PATH2CAPO}/omni/omni_run.py -p ${POLS} -C ${CAL} --minV --omnipath=${OMNIPATH_s2e4} --ex_bls=${BADBLS} --ba=${BADANTS_s2e4} ${fFc}
